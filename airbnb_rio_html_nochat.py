...
def main():
    ...
    with tabs[1]:
        ...
        with colT2:
            ...
            st.components.v1.html(map4_html, width=1100, height=850)
    ...
    with tabs[2]:
        ...
        #fig = px.histogram(df_copy1, x='neighbourhood_cleansed', y='price', color='neighbourhood_cleansed', barmode='group')
